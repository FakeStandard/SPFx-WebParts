...
import { ISimpleListOperationsProps } from "./components/ISimpleListOperationsProps";
...
export default class SimpleListOperationsWebPart extends BaseClientSideWebPart<ISimpleListOperationsWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ISimpleListOperationsProps> =
      React.createElement(SimpleListOperations, {
